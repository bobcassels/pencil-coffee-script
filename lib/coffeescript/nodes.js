...
(function() {
  ...
  exports.NumberLiteral = NumberLiteral = class NumberLiteral extends Literal {
    compileNode(o) {
      ...
      if (o.numeric) {
        ...
        digits = base === 10 ? string : string.slice(2);
        return (numericValue(o, digits, base)).compileNode(o);
      } else {
    ...
    class Assign extends Base {
      ...
      compileNode(o) {
        ...
        if (isValue) {
          ...
          if (this.context && (((ref2 = this.context) === '**=' || ref2 === '//=' || ref2 === '%%=') || o.numeric && this.context.match(/^[-+*\/%]=$/))) {
  ...
  exports.Op = Op = (function() {
    ...
    class Op extends Base {
      ...
      compileNumericArithmetic(o, name, numericFn) {
        return compileNumericFunctionCall(o, name, numericFn, [this.first, this.second]);
      }

      compileNode(o) {
        var answer, isChain, lhs, message, numericFn, op, relationName, rhs;
        isChain = this.isChainable() && this.first.isChainable();
        if (!isChain) {
          this.first.front = this.front;
        }
        op = this.operator;
        if (op === 'delete' && o.scope.check(this.first.unwrapAll().value)) {
        ...
        if (o.numeric) {
          ...
          if (relationName) {
            return this.compileNumericRelation(o, relationName);
          }
          numericFn = {
            '/': ['div'],
            '*': ['mul'],
          ...
          if (numericFn) {
            return this.compileNumericArithmetic(o, numericFn[0], numericFn[1] || op);
          }
        }
        switch (op) {
          case '?':
          ...
          default:
            ...
            answer = [].concat(lhs, this.makeCode(` ${op} `), rhs);
            if (o.level <= LEVEL_OP) {
              return answer;
            } else {
              return this.wrapInParentheses(answer);
      ...
      compileUnary(o) {
        ...
        if (o.numeric) {
          switch (op) {
            ...
            case '-':
              return compileNumericFunctionCall(o, 'neg', '-', [this.first]);
            case '--':
            case '++':
      ...
      compileAddNumeric(o) {
        ...
        return this.compileNumericWrapperArithmetic(o, 'add', 'add', '+', function(addFn) {
      ...
      compileNumericRelation(o, relationName) {
        ...
        if (this.first.isNumber() || this.second.isNumber()) {
          return this.compileNumericArithmetic(o, relationName, relation);
        }
        return this.compileNumericWrapperArithmetic(o, relationName, relationName, relation, function(relationFn) {
      ...
      compileEqlNumeric(o) {
        ...
        return this.compileNumericWrapperArithmetic(o, 'eql', 'eql', '=', function(eqlFn) {
      ...
      compileNeqNumeric(o) {
        var isNumber;
        isNumber = numericFunction(o, 'isn', 'number?');
        return this.compileNumericWrapperArithmetic(o, 'neq', 'eql', '=', function(eqlFn) {
          return `function (a, b) {\n  if ((${isNumber}(a) or typeof a === 'number') and\n      (${isNumber}(b) or typeof b === 'number')) {\n    return !${eqlFn}(a, b);\n  }\n  return a !== b;\n}`;
        });
      }

      compileIncDecNumeric(o) {
        var left, name, one, op, ref, right;
        [left, right] = this.first.cacheReference(o);
        one = numericValue(o, '1');
        op = this.operator.slice(0, -1);
        name = {
          '+': 'add',
          '-': 'sub'
        }[op];
        if (this.flip) {
          ref = new IdentifierLiteral(o.scope.freeVariable('ref'));
          return (new Block([new Assign(left, numericFunctionCall(o, name, op, [new Assign(ref, right), one])), ref])).compileToFragments(o);
        } else {
          return new Assign(left, numericFunctionCall(o, name, op, [right, one])).compileToFragments(o);
        }
      }

      toString(idt) {
        return super.toString(idt, this.constructor.name + ' ' + this.operator + (this.flip ? ' (postfix)' : ''));
      }
  ...
  UTILITIES = {
    ...
    SchemeNumber: function() {
      return "typeof require === 'undefined' ? SchemeNumber : require('./schemeNumber').SchemeNumber";
    }
  };
  ...
  numericFunctionWrapper = function(o, wrapperName, name, schemeFn, makejs) {
    var ref, sref;
  ...
  numericFunction = function(o, name, schemeFn) {
  ...
  numericValue = function(o, string, radix = 10) {
    var args, name, ref, stringToNumber;
    if (radix !== 10 && string.length <= 13) {
    ...
    return new Value(new Literal(ref));
  };

  numericFunctionCall = function(o, name, numericFn, args) {
    var sfn;
    sfn = new Value(new Literal(numericFunction(o, name, numericFn)));
    return new Call(sfn, args);
  };

  compileNumericFunctionCall = function(o, name, numericFn, args) {
    return (numericFunctionCall(o, name, numericFn, args)).compileNode(o);
  };
