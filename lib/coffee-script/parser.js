...
this.$ = $$[$0];
break;
case 10: case 29: case 33: case 34: case 35:
...
this.$ = yy.addLocationDataFn(_$[$0-2], _$[$0])((function () {
        if ($$[$0-1] instanceof yy.Block && $$[$0-1].expressions.length === 1 && $$[$0-1].expressions[0] instanceof yy.Value && $$[$0-1].expressions[0].bareLiteral(yy.Literal) && $$[$0-1].expressions[0].base.kind === 'NUMBER') {
...
this.$ = yy.addLocationDataFn(_$[$0-4], _$[$0])((function () {
        if ($$[$0-2] instanceof yy.Block && $$[$0-2].expressions.length === 1 && $$[$0-2].expressions[0] instanceof yy.Value && $$[$0-2].expressions[0].bareLiteral(yy.Literal) && $$[$0-2].expressions[0].base.kind === 'NUMBER') {
...
this.$ = yy.addLocationDataFn(_$[$0-1], _$[$0])((function () {
        var negated, value;
        if ($$[$0] instanceof yy.Value && $$[$0].bareLiteral(yy.Literal) && $$[$0].base.kind === 'NUMBER') {
          value = $$[$0].base.value;
          if (/^\+/.test(value)) {
            value = value.slice(1);
          }
          negated = /^-/.test(value) ? value.slice(1) : "-" + value;
          return new yy.Value(new yy.Literal(negated, 'NUMBER'));
        } else {
          return new yy.Op('-', $$[$0]);
        }
      }()));
...
case 208:
this.$ = yy.addLocationDataFn(_$[$0-2], _$[$0])((function () {
        var RATIONAL, aDen, aImag, aNum, aPositive, bDen, bImag, bNum, bPositive, gcd, imag, positive, rational, rationalParts, rationalReduce, sign, _ref, _ref1;
        RATIONAL = /^([+-]?)(\d+)(\/(\d+))?(i?)$/;
        ...
        rationalReduce = function(num, den) {
          var factor;
          if (num < Math.pow(2, 53) && (0 < den && den < Math.pow(2, 53))) {
            factor = gcd(num, den);
            num = num / factor;
            den = den / factor;
            if (den === 1) {
        ...
        if ($$[$0-1] === '/' && $$[$0-2] instanceof yy.Value && $$[$0-2].bareLiteral(yy.Literal) && $$[$0-2].base.kind === 'NUMBER' && RATIONAL.test($$[$0-2].base.value) && $$[$0] instanceof yy.Value && $$[$0].bareLiteral(yy.Literal) && $$[$0].base.kind === 'NUMBER' && RATIONAL.test($$[$0].base.value)) {
          _ref = rationalParts($$[$0-2].base.value), aPositive = _ref[0], aNum = _ref[1], aDen = _ref[2], aImag = _ref[3];
          _ref1 = rationalParts($$[$0].base.value), bPositive = _ref1[0], bNum = _ref1[1], bDen = _ref1[2], bImag = _ref1[3];
          ...
          sign = positive ? '' : '-';
          if (rational) {
            return new yy.Value(new yy.Literal("" + sign + rational + imag, 'NUMBER'));
          } else {
