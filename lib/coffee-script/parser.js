...
this.$ = yy.addLocationDataFn(_$[$0-2], _$[$0])((function () {
        if ($$[$0-1] instanceof yy.Block && $$[$0-1].expressions.length === 1 && $$[$0-1].expressions[0] instanceof yy.Value && $$[$0-1].expressions[0].isNumber()) {
...
this.$ = yy.addLocationDataFn(_$[$0-4], _$[$0])((function () {
        if ($$[$0-2] instanceof yy.Block && $$[$0-2].expressions.length === 1 && $$[$0-2].expressions[0] instanceof yy.Value && $$[$0-2].expressions[0].isNumber()) {
...
this.$ = yy.addLocationDataFn(_$[$0-1], _$[$0])((function () {
        var negated, value;
        if ($$[$0] instanceof yy.Value && $$[$0].isNumber()) {
          value = $$[$0].base.value;
          if (/^\+/.test(value)) {
            value = value.slice(1);
          }
...
this.$ = yy.addLocationDataFn(_$[$0-2], _$[$0])((function () {
        ...
        if ($$[$0-1] === '/' && $$[$0-2] instanceof yy.Value && $$[$0-2].isNumber() && RATIONAL.test($$[$0-2].base.value) && $$[$0] instanceof yy.Value && $$[$0].isNumber() && RATIONAL.test($$[$0].base.value)) {
