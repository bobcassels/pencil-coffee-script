...
(function() {
  ...
  grammar = {
    ...
    Parenthetical: [
      o('( Body )', function() {
        if ($2 instanceof yy.Block && $2.expressions.length === 1 && $2.expressions[0] instanceof yy.Value && $2.expressions[0].bareLiteral(yy.Literal) && $2.expressions[0].base.kind === 'NUMBER') {
          return $2.expressions[0];
        } else {
          return new Parens($2);
        }
      }), o('( INDENT Body OUTDENT )', function() {
        if ($3 instanceof yy.Block && $3.expressions.length === 1 && $3.expressions[0] instanceof yy.Value && $3.expressions[0].bareLiteral(yy.Literal) && $3.expressions[0].base.kind === 'NUMBER') {
    ...
    Operation: [
      o('UNARY Expression', function() {
        ...
        var negated, value;
        if ($2 instanceof yy.Value && $2.bareLiteral(yy.Literal) && $2.base.kind === 'NUMBER') {
          value = $2.base.value;
          if (/^\+/.test(value)) {
            value = value.slice(1);
          }
        ...
        if ($2 === '/' && $1 instanceof yy.Value && $1.bareLiteral(yy.Literal) && $1.base.kind === 'NUMBER' && /^[-+]?\d+(\/\d+)?$/.test($1.base.value) && $3 instanceof yy.Value && $3.bareLiteral(yy.Literal) && $3.base.kind === 'NUMBER' && /^[-+]?\d+(\/\d+)?$/.test($3.base.value)) {
          ...
          if (rNum < Math.pow(2, 53) && (0 < rDen && rDen < Math.pow(2, 53))) {
            ...
            return new Value(new Literal("" + sign + ratio, 'NUMBER'));
          } else {
            return new Op($2, $1, $3);
          }
        } else {
