...
(function() {
  ...
  grammar = {
    ...
    Parenthetical: [
      o('( Body )', function() {
        if ($2 instanceof Block && $2.expressions.length === 1 && $2.expressions[0] instanceof Value && $2.expressions[0].isNumber()) {
          return $2.expressions[0];
        } else {
          return new Parens($2);
        }
      }), o('( INDENT Body OUTDENT )', function() {
        if ($3 instanceof Block && $3.expressions.length === 1 && $3.expressions[0] instanceof Value && $3.expressions[0].isNumber()) {
    ...
    Operation: [
      o('UNARY Expression', function() {
        ...
        var negated, value;
        if ($2 instanceof Value && $2.isNumber()) {
          value = $2.base.value;
          if (/^\+/.test(value)) {
            value = value.slice(1);
          }
        ...
        if ($2 === '/' && $1 instanceof Value && $1.isNumber() && RATIONAL.test($1.base.value) && $3 instanceof Value && $3.isNumber() && RATIONAL.test($3.base.value)) {
