...
(function() {
  ...
  grammar = {
    ...
    Parenthetical: [
      o('( Body )', function() {
        if ($2 instanceof Block && $2.expressions.length === 1 && $2.expressions[0].isLiteralObject()) {
          return $2.expressions[0];
        } else {
          return new Parens($2);
        }
      }), o('( INDENT Body OUTDENT )', function() {
        if ($3 instanceof Block && $3.expressions.length === 1 && $3.expressions[0].isLiteralObject()) {
