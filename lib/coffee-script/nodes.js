...
(function() {
  ...
  exports.Literal = Literal = (function(_super) {
    ...
    Literal.prototype.compileNode = function(o) {
      ...
      if (this.kind === 'Number') {
        if (o.schemeNumbers) {
          if (EXACT_REAL.test(this.value) || /i$/i.test(this.value)) {
  ...
  exports.Value = Value = (function(_super) {
    ...
    Value.prototype.isPrimitive = function() {
      var _ref2;
      return this.bareLiteral(Literal) && ((_ref2 = this.base.value) === 'Number' || _ref2 === 'String' || _ref2 === 'Null' || _ref2 === 'Undefined');
    };
  ...
  exports.Op = Op = (function(_super) {
    ...
    Op.prototype.compileNode = function(o) {
      var answer, isChain, lhs, rhs, schemeOp, sfn, _ref2, _ref3;
  ...
  UTILITIES = {
    ...
    SchemeNumber: function() {
      return "require('./../javascript-bignum/schemeNumber').SchemeNumber";
    },
    modulo: function() {
